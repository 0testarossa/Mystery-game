...
public class Book : MonoBehaviour
{
    ...
    private void checkScreen()
    {
        if (isChangingOpcacityScreen)
        {
            if (actualScreenIndex < allScreens.Length)
            {
                ...
                tempColor.a = tempColor.a + (0.5f / timeToShowScreen) * Time.deltaTime;
                ...
                if (actualScreenIndex > 0)//znikanie zeszlego obrazka
                {
                    ...
                    tempColor2.a = tempColor2.a - (0.5f / timeToShowScreen) * Time.deltaTime;
    ...
    private void checkBorder()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space))
        {
            if (actualBorderIndex < 2 && borders[actualBorderIndex].color.a != 0.5f && timeLeftToShowBorder == timeToShowScreen)
            {
                isChangingOpcacityBorder = true;
                borders[actualBorderIndex].enabled = true;
            }
